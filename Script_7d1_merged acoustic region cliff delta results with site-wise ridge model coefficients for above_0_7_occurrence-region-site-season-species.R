...
# Read the Excel file
df1 <- read_excel("D:/Acoustic_Regions_filtered_Raven_Events_All_Region/output/Minute_Regularisation_models_cliff_delta/For Renaming and Combining Features of Acoustic Region Cliff Delta Results (top 20 percent).xlsx ")
...
write_xlsx(merged_df, paste0(output_dir, "Merged Acoustic Region Cliff Delta Results with Site-Wise Ridge Model Coefficients.xlsx"))
