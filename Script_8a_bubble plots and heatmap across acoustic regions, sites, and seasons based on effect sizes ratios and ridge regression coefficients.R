...
# Save the plot
ggsave(filename = "above_0_7__20%_top_ratios_Pairwise scatterplot showing interactions of Coefficients, Ratios, Acoustic Regions, Indices, Site, and Season1.png", plot = plot, path = output_dir, width = 20, height = 12, dpi = 300)
########################
...
if(nrow(merged_data) > 0) {
  ...
  # Save the bubble plot as a PNG file with an appropriate size
  ggsave(filename = paste0(output_dir, "/above_0_7_without_Sites__20%_top_ratios_Bubble_Plot_of_Coefficients_by_Region_Index_and_Species__FINAL1.png"), plot = bubble_plot, width = 25, height = 25)
}
...
if(nrow(merged_data) > 0) {
  ...
  # Save the bubble plot as a PNG file with an appropriate size
  ggsave(filename = paste0(output_dir, "/above_0_7_with_Sites_20%_top_ratios_Bubble_Plot_of_Coefficients_by_Region_Index_and_Species__FINAL1.png"), plot = bubble_plot, width = 15, height = 13)
}
...
if(nrow(merged_data) > 0) {
  ...
  # Save the bubble plot as a PNG file with an appropriate size
  ggsave(filename = paste0(output_dir, "/above_0_7_with_Sites2_20%_top_ratios_Bubble_Plot_of_Coefficients_by_Region_Index_and_Species__FINAL1.png"), plot = bubble_plot, width = 15, height = 13)
}