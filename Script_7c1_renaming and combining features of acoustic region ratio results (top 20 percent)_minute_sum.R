...
output_file_path <- "D:/Acoustic_Regions_filtered_Raven_Events_All_Region/output/Minute_Regularisation_models_minute_sum/For Renaming and Combining Features of Acoustic Region Ratio Results (top 20 percent).xlsx"

# Write top_20_percent to an Excel file
